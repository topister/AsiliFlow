    ...
    >
      ...
      <Container className="text-center py-5">
        ...
        <p className="mt-3 text-muted">
          ...
          while maintaining a biodegradable nature. Our goal is to provide safe
          and eco-friendly sanitary products that support both you and the
          environment.
        </p>
      </Container>
      ...
      <div className="bg-light py-5">
        <Container className="text-center">
          ...
          <p className="mt-3 text-muted">
            To revolutionize menstrual hygiene with eco-friendly solutions that
            empower women and protect the planet.
          </p>
        </Container>
      </div>
      {/* Core Values */}
